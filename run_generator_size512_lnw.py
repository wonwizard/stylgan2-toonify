...
def generate_images(network_pkl, seeds, truncation_psi, file_name):
    ...
    for seed_idx, seed in enumerate(seeds):
        ...
        PIL.Image.fromarray(images[0], 'RGB').resize(size=(512,512)).save(dnnlib.make_run_dir_path(file_name+'%04d.png' % seed))


#----------------------------------------------------------------------------

def style_mixing_example(network_pkl, row_seeds, col_seeds, truncation_psi, col_styles, minibatch_size=4):
    print('Loading lnw networks from "%s"...' % network_pkl)
    _G, _D, Gs = pretrained_networks.load_networks(network_pkl)
...
Run 'python %(prog)s <subcommand> --help' for subcommand help.''',
    ...
    #lnw add
    parser_generate_images.add_argument('--file-name', help='file name (default: %(default)s)', default='seed512-')
    ...
    func_name_map = {
        ...
        'generate-images': 'run_generator_size512_lnw.generate_images',
        'style-mixing-example': 'run_generator_size512_lnw.style_mixing_example'
    }
