...
def main():
    ...
    coeffs22 = [0., 0., 0., 0., 15., 30., 45., 15., 0., 0., 0., 0., 0., 0., 0.]   # for fast eyes2
    coeffs3 = [0., 0., 0., -1., -2., -3., -4., -5., -4., -3., -2., -1., 0., 0., 0.]  # for angle_horizontal  pich / head down
    coeffs4 = [0., 0., 0., -10., -20., -30., -40., -50., -50., -25., 0., 0., 0., 0., 0.] # for many pich / head down
    coeffs5 = [0., 0., 0., 5., 10., 15., 20., 25., 30., 30., 15., 0., 0., 0., 0.]   # for happy sad surprise 
    coeffs6 = [0., 0., 0., 2., 4., 6., 8., 10., 8., 6., 4., 2., 0., 0., 0.]   # for angly  many angle_horizontal
    coeffs62 = [0., 0., 0., 15., 30., 45., 60., 75., 40., 0., 0., 0., 0., 0., 0.]   # for angly small angle_horizontal
    coeffs10 = [0., 0., -50., -40., -30., -20., -10., 0., 0., 10., 20., 30., 40., 50., 0.]  # new
